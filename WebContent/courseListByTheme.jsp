						...
						<div class="collapse navbar-collapse main-menu-item"
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item dropdown"><a
									...
									aria-expanded="false"> Drive Course </a>
									<div class="dropdown-menu" aria-laballedby="navbarDropdown">
										<a class="dropdown-item" href="themelist.jsp">Theme</a> <a
											class="dropdown-item" href="locationlist.jsp">Location</a>
									</div></li>
								<li class="nav-item dropdown"><a
					...
					<div class="col-lg-4 col-sm-4">
						<div class="single_blog_part">
							...
							<div class="blog_text">
								...
								<p>
									<c:out value="${course.dist}"></c:out>
									km
								</p>
								<ul>
									<li><i class="ti-calendar"></i>
										<p>
											<c:out value="${course.totalTime}"></c:out>
											분
										</p></li>
									<li><i class="ti-heart"></i>
										<p>
											<c:out value="${course.heart }"></c:out>
										</p> <!-- 이부분에 나중에 star rate 넣을 예정. --></li>
